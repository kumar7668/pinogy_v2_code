...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TestimonialFormPluginModel'
        db.create_table(u'pinogy_testimonials_testimonialformpluginmodel', (
        ...
        db.send_create_signal(u'pinogy_testimonials', ['TestimonialFormPluginModel'])


    def backwards(self, orm):
        # Deleting model 'TestimonialFormPluginModel'
        db.delete_table(u'pinogy_testimonials_testimonialformpluginmodel')
