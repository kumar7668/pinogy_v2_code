...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TestimonialQuotesPluginModel'
        db.create_table(u'pinogy_testimonials_testimonialquotespluginmodel', (
        ...
        db.send_create_signal(u'pinogy_testimonials', ['TestimonialQuotesPluginModel'])


    def backwards(self, orm):
        # Deleting model 'TestimonialQuotesPluginModel'
        db.delete_table(u'pinogy_testimonials_testimonialquotespluginmodel')
