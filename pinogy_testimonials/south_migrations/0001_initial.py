...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'pinogy_testimonials_testimonial', (
        ...
        db.send_create_signal(u'pinogy_testimonials', ['Testimonial'])

    def backwards(self, orm):
        # Deleting model 'Testimonial'
        db.delete_table(u'pinogy_testimonials_testimonial')
