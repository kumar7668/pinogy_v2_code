...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TestimonialCarouselPluginModel'
        db.create_table(u'pinogy_testimonials_testimonialcarouselpluginmodel', (
            ...
            ('max_testimonials', self.gf('django.db.models.fields.PositiveIntegerField')(default=5)),
            ('restrict_to_featured', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('restrict_to_images', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('show_add_option', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'pinogy_testimonials', ['TestimonialCarouselPluginModel'])


    def backwards(self, orm):
        # Deleting model 'TestimonialCarouselPluginModel'
        db.delete_table(u'pinogy_testimonials_testimonialcarouselpluginmodel')
    ...
    models = {
        ...
        u'pinogy_testimonials.testimonialcarouselpluginmodel': {
            ...
            'restrict_to_images': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
